...
$arr_abandonos = criaArray(geraSqlAbandonos2($_REQUEST["trecho"], $_REQUEST["categoria"], $_REQUEST["modalidade"], $_REQUEST["mod"]));
$lista = geraDadosAbandonos($arr_abandonos);

//--------------------------------------------------------------------------
//--------------------------------------------------------------------------
// Definindo o que vai no header da página
$txt_pag = "RELACAO DE ABANDONOS<br>";
