...
`mode com4: baud=9600 parity=n data=8 stop=1 to=on xon=off`;
 ...
 while (true) {
  ...
  //if (@ereg('\$READ\$', $linha)) {
   ...
   if (strlen($dados)<16)
   {
	...
	$tempo = $hh*3600+$mm*60+$ss+$dc/100;
	$trecho=1;
	$mct='1111';
	
	$sql = "INSERT INTO t01_tempos (c01_valor, c01_tipo, c01_status, c03_codigo, c02_codigo, c01_sigla, c01_conta, c01_mct) VALUES ($tempo, 'C', getTempoStatus($competidor, $trecho, 'C'), getCodigoVeiculo($competidor), $trecho, 'AD', $mct, $mct)";
