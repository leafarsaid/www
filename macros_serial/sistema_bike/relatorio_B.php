...
<span style="font-size: 30px; color: yellow; display: block; width: 100%; text-align: center;"></span>
<span style="font-size: 60px; color: yellow; display: block; width: 100%; text-align: center;"> Renault Megane RS - Amarelo </span>
<span style="clear: left; font-size: 180px; color: yellow; display: block; width: 100%; text-align: center;"><?= substr($txtTempo,3); ?></span>
<span style="font-size: 60px; color: yellow; display: block; width: 100%; text-align: center;">nº<?= $txtNumeral ?> - <?= $txtCategoria ?> - <?= $txtPiloto ?></span>
</div>
</tr>
